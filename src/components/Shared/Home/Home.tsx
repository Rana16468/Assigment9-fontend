          ...
          <div className="flex flex-wrap items-center sm:-mx-3">
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  It never been easier to build beautiful websites that convey
            ...
            <div className="w-full md:w-1/2">
              <div className="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <Image
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQsl9Ag8SR6NER2I3L3oxqJGY3Ih5KlEPYOWg&s"
                  alt=""
                  width={500}
                  height={500}
                />
            ...
            <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
              <div className="w-full lg:max-w-md">
                ...
                <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                  It never been easier to build a business of your own. Our
